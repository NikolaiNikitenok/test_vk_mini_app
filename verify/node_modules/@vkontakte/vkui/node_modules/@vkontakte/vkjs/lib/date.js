...
exports.getUnixTimestampFromDate = getUnixTimestampFromDate;
exports.convertDateToInputFormat = convertDateToInputFormat;
exports.SECONDS_IN_THE_DAY = void 0;

var _numbers = require("./numbers");

var SECONDS_IN_THE_DAY = 86400;
exports.SECONDS_IN_THE_DAY = SECONDS_IN_THE_DAY;
...
function convertDateToInputFormat(date) {
  ...
  var year = date.getFullYear();
  return [year, (0, _numbers.leadingZero)(month), (0, _numbers.leadingZero)(day)].join('-');
}
